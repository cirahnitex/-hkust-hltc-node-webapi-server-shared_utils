...
declare module "mongoose" {
    ...
    class CastError extends MongooseError {
         ...
         */
        constructor(type: string, value: any, path: string, reason?: Error);
    }
    ...
    class Schema extends events.EventEmitter {
        ...
        post<T extends Document>(method: string, fn: (
            error: mongodb.MongoError, doc: T, next: (err?: Error) => void
        ) => void): this;

        post<T extends Document>(method: string, fn: (
            doc: T, next: (err?: Error) => void
        ) => void): this;
    ...
    class MongooseDocument {
         ...
         */
        invalidate(path: string, errorMsg: string | Error, value: any, kind?: string): ValidationError | boolean;
         ...
         */
        validateSync(pathsToValidate?: string | string[]): MongooseError;
    ...
    namespace Types {
        ...
        class DocumentArray<T extends MongooseDocument> extends Types.Array<T> {
             ...
             */
            id(id: ObjectId | string | number | Buffer): T;
        ...
        class Buffer extends global.Buffer {
             ...
             */
            copy(target: Buffer, ...nodeBufferArgs: any[]): number;
        ...
        class Embedded extends MongooseDocument {
             ...
             */
            invalidate(path: string, err: string | Error): boolean;
    ...
    namespace Schema {
        namespace Types {
            ...
            /*
              ...
              */
            class MongooseDate extends SchemaType {
                 ...
                 * @param message optional custom error message
                 */
                max(maximum: Date, message?: string): this;
            ...
            /*
              ...
              */
            class MongooseBuffer extends SchemaType {
